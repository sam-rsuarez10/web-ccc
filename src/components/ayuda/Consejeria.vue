					...
					<div class="bee-block bee-block-1 bee-text">
						<div class="bee-text-content"
							...
							<p style="font-size: 18px; line-height: 27px; text-align: left;"><span
										style="font-size: 18px; line-height: 27px;">Lorem ipsum dolor sit amet,
										consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
										dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
										laboris nisi ut aliquip ex ea commodo consequat. </span><span
										style="font-size: 18px; line-height: 27px;">Duis aute irure dolor in
                        ...
                        <div class="buttons">
                            ...
                            >
                                <a href="#" target="_blank">Reservar hora</a>
                            </button>
                        </div>
					</div>
				</div>

          ...
          <b-collapse id="nav-collapse" is-nav>
            ...
            <b-navbar-nav class="ms-auto">
              ...
              <b-nav-item-dropdown text="Grupos" class="m-md-2 navLista">
                ...
                <b-dropdown-item
                  ><a href="">Reuniones en Casa</a></b-dropdown-item
                >
              ...
              >
                ...
                >
                <b-dropdown-item
                  ><a href="">Estudios Biblicos</a></b-dropdown-item
                >
              </b-nav-item-dropdown>
              ...
              <b-nav-item class="m-md-2">Contactanos</b-nav-item>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="banner-left">
                ...
                <div class="subtitulo">
                  <h2>A CENTRO CRECIMIENTO CRISTIANO LAS CONDES</h2>
                </div>
                <div class="botones">
                  <button
                    type="button"
                  ...
                  >
                    <a href="#" target="_blank">Reuniones</a>
                  </button>
                  <button
                    type="button"
                    class="btn btn-primary btn-lg"
                    ...
                    data-aos-duration="1500"
                  >
                    <a href="#" target="_blank">¿En que te ayudamos?</a>
                  </button>
                  <button
                    type="button"
                    class="btn btn-primary btn-lg"
